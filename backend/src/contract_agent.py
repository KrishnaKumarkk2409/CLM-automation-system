...
class ContractAgent:
    ...
    def generate_daily_report(self) -> Dict[str, Any]:
        ...
        try:
            ...
            Format the report professionally for email distribution.
            """)
    ...
    def send_report_email(self, report_data: Dict[str, Any], 
        ...
        """Send daily report via email with improved error handling"""
        try:
            ...
            if not Config.EMAIL_USERNAME:
                ...
                raise ValueError("Email username not configured")
            ...
            logger.info(f"Using SMTP server: {Config.SMTP_SERVER}:{Config.SMTP_PORT}")
...
Summary:
- Expiring Contracts: {report_data.get('expiring_contracts', 0)}
- Conflicts Found: {report_data.get('conflicts_found', 0)}

Detailed Report:
{report_data.get('report_content', 'No content available')}

---
This is an automated report generated by the CLM System.
For questions or support, please contact your system administrator.
            ...
            logger.info(f"✅ Daily report email successfully sent to {recipient}")
            return True
            
        except smtplib.SMTPAuthenticationError as e:
            logger.error(f"❌ SMTP Authentication failed: {e}. Check email credentials.")
            return False
        except smtplib.SMTPConnectError as e:
            logger.error(f"❌ SMTP Connection failed: {e}. Check SMTP server settings.")
            return False
        except smtplib.SMTPRecipientsRefused as e:
            logger.error(f"❌ Recipient email refused: {e}. Check recipient email address.")
            return False
        except Exception as e:
    ...
    def run_daily_monitoring(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if Config.REPORT_EMAIL:
                email_sent = self.send_report_email(report_data)
